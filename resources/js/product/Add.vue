                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-2">
                                        <div class="form-group">
                                            ...
                                            <label>No</label>
                                            <p class="errors">{{errors.decorguys}}</p>
                                        </div><hr>
                                    </div>
                                    <div class="col-12 mb-2">
                                        <div class="form-group">
                                            ...
                                            <label>No</label>
                                            <p class="errors">{{errors.carstickers}}</p>
                                        </div><hr>
                                    </div>
                                    <div class="col-12 mb-2">
                                        <div class="form-group">
                                    ...
                                    <div class="col-12 mb-2">
                                        <div class="form-group">
                                            <label>Other Artcut File</label><br>
